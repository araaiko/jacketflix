...
export const requests = {
  ...
  fetchTopRated: `/discover/tv?api_key=${process.env.REACT_APP_TMDB_API_KEY}&languager=en-us`,
  ...
  fetchDocumentMovies: `/discover/tv?api_key=${process.env.REACT_APP_TMDB_API_KEY}&with_genres=99`,
};
